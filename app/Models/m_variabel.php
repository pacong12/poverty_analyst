...
class M_Variabel extends CI_Model
{
    ...
    function update_variabel_penduduk($where, $array, $table)
    { //$variabel_id,$nama_variabel,$jenis_io
        $this->db->where($where);
        $this->db->update($table, $array);
    }

    function update_variabel_penduduk_aset($where, $array, $table)
    { //$variabel_id,$nama_variabel,$jenis_io
        $this->db->where($where);
        $this->db->update($table, $array);
    }

    function update_variabel_penduduk_program($where, $array, $table)
    { //$variabel_id,$nama_variabel,$jenis_io
        $this->db->where($where);
        $this->db->update($table, $array);
    }
